    ...
    followUpFields: [
      {
        ...
        label: "Çözüm Detayı",
        type: "textarea",
        placeholder: "Yapılan işlemin detaylarını açıklayın",
        required: true,
      },
      {
        id: "followup_2",
        ...
        label: "Durum",
        type: "select",
        placeholder: "İşlem durumunu seçin",
        required: true,
        options: [
      ...
      },
      {
        ...
        label: "Ek Notlar",
        type: "textarea",
        placeholder: "Varsa ek notlarınızı ekleyin",
        required: false,
      },
    ],
  },
    ...
    followUpFields: [
      {
        ...
        label: "Onay Durumu",
        type: "select",
        placeholder: "Onay durumunu seçin",
        required: true,
        options: [
      ...
      },
      {
        ...
        label: "Onay Notları",
        type: "textarea",
        placeholder: "Onay/red gerekçesini açıklayın",
        required: true,
      },
      {
        id: "followup_6",
